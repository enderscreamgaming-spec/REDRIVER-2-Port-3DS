...
#ifdef __3DS__
#define FE_HIRES_FONT_SCALE_BASE 0.58f
#define FE_HIRES_FONT_Y_OFFSET 30.0f
#define FE_HIRES_FONT_SHADOW_OFFSET 1.5f
#define FE_HIRES_FONT_SHADOW_R 0
#define FE_HIRES_FONT_SHADOW_G 0
#define FE_HIRES_FONT_SHADOW_B 0
#else
#define FE_HIRES_FONT_SCALE_BASE 0.5f
#define FE_HIRES_FONT_Y_OFFSET 32.0f
#define FE_HIRES_FONT_SHADOW_OFFSET 1.0f
#define FE_HIRES_FONT_SHADOW_R 10
#define FE_HIRES_FONT_SHADOW_G 10
#define FE_HIRES_FONT_SHADOW_B 10
#endif
...
int FEGetHiresBakedQuad(int char_index, float scale, float* xpos, float* ypos, FEFONT_QUAD* q)
{
	...
	float fscale = FE_HIRES_FONT_SCALE_BASE * scale;
...
int FEPrintStringSizedHires(char* string, int x, int y, int scale, int transparent, int r, int g, int b)
{
	...
	while ((let = *string++) != 0)
	{
		...
		setRGB0(shadow, FE_HIRES_FONT_SHADOW_R, FE_HIRES_FONT_SHADOW_G, FE_HIRES_FONT_SHADOW_B);
		setXYWH(shadow, q.x0 + FE_HIRES_FONT_SHADOW_OFFSET, q.y0 + FE_HIRES_FONT_SHADOW_OFFSET, q.x1, q.y1);
