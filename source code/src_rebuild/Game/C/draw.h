...
// 3DS performance caps for the software renderer.
#define MAX_DRAWN_BUILDINGS		144
#define MAX_DRAWN_TILES			240
#define MAX_DRAWN_ANIMATING		14
#define MAX_DRAWN_SPRITES		56

#define DRAW_LOD_DIST_HIGH		2500
#define DRAW_LOD_DIST_LOW		4200
